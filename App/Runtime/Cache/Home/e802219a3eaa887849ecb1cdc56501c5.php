...
<div class="banner">
	...
	<?php default: endswitch;?>
							<div class="right_main" style="line-height:25px;">
						<div class="page-header off" style="text-align: center;">
						  <h2><?php echo ($article['title']); ?><br><small>发布：<?php echo ($user['username']); ?> 浏览：<?php echo ($article['click']); ?>次</small></h2>
						</div>
						<div class="cus-con">
							<?php if($article['id'] == 3): ?><embed type="application/x-shockwave-flash" classid="clsid:d27cdb6e-ae6d-11cf-96b8-4445535400000" src="../Public/swf/dt.swf" wmode="transparent" quality="high" menu="false" play="true" loop="true" allowfullscreen="true" width="100%" height="500" /><?php endif; ?>
							<?php echo ($article['content']); ?></div></div>
					</div>
				</div>
